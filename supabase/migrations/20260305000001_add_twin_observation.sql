...
ALTER TABLE IF EXISTS athlete_ai_profiles ADD COLUMN IF NOT EXISTS micro_wins JSONB;
ALTER TABLE IF EXISTS athlete_ai_profiles ADD COLUMN IF NOT EXISTS micro_wins_generated_at TIMESTAMPTZ;
